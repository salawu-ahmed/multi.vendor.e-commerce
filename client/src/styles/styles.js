const styles = {
    ...
    productDiscountPrice: "text-[18px] font-bold font-Roboto text-[#333]",
    price: "text-[16px] font-[500] font-Roboto text-[#d55b45] pl-3 mt-[-4px] line-through",
